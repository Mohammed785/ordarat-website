import { IsEmail, IsIn, IsOptional, IsPhoneNumber, Length } from "class-validator"
...
export class UserCreateDTO extends RegisterDTO{
    @IsIn(["OPERATION","CALL_CENTER"],{message:"يجب ان يكون نوع المستخدم كول سينتر او اوبيراشن"})
    role: string;
}
